from file_check import read_config, check_for_saildrone_data, check_for_saildrone_shapefile
...
if not config["convert_saildrone_coordinates_to_shapefile"]:
    ...
    print(f"Converting saildrone {config['saildrone_number']} from {config['saildrone_year']} coordinates to shapefile.")
